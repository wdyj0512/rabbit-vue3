...
import { changeResult } from '@/components/city/index.vue';
...
const hChengeCity = (city:changeResult)=>{
    address.value = `${city.provinceName} ${city.cityName} ${city.countyName}`
}
const address = ref<string>('河南省 信阳市 罗山县')
</script>
<template>
  ...
  <div class="g-service">
    ...
    <dl>
      <dt>配送</dt>
      <dd>至 <XtxCity :address="address" @change-city="hChengeCity" /></dd>
    </dl>
    <dl>
      <dt>服务</dt>
      <dd>
